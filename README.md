Проект запускается командой yarn start, перед запуском убедитесь в том, что установлены необходимые пакеты (названия пакетов находятся в package.json, обновить их можно командой yarn upgrade)
